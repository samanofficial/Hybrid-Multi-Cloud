...
resource "aws_security_group" "my_security100" {
  name        = "my_security100"
...
resource "aws_instance" "myin" {
  ...
  key_name = "saman"
  security_groups = ["my_security100"]
...
resource "aws_efs_file_system" "efs1" {
   depends_on = [aws_security_group.my_security100 , aws_instance.myin ,]
...
resource "aws_efs_mount_target" "EFS_mount" {
  ...
  security_groups = [aws_security_group.my_security100.id]
}
...
resource "aws_s3_bucket_object" "object"{
  ...
  acl = "public-read"
  key = "sample.png"
  source = "C:/Users/singh/Desktop/terraform/task2/images/sample.png"
